...
//#1
int64 nChainStartTime = 1521786303;
...
const string strMessageMagic = "HealSharesChain Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in HealSharesChain
    bool fStrictPayToScriptHash = true; // Always active in HealSharesChain
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "HealSharesChain", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        //#1
        const char* pszTimestamp = "HealSharesChain created by SMITH 2017/07/06";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = nChainStartTime + 70;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        //#1
        assert(block.hashMerkleRoot == uint256("0x3d6103f975bbfca8481d6b9dbfeee9be72b6c21fddaa3d1644c488dfd03255b5"));
